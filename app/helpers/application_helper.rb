module ApplicationHelper
  ...
  # one fixed class and an optional theme name class.
  #
  # You can pass inline styles, to style individual components independent.
  #
  def erbv_html(theme: nil, style: nil, &block)
